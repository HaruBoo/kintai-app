...
function KintaiPage() {
  ...
  const [records, setRecords] = useState<DayRecord[]>(() =>
    loadFromStorage<DayRecord[]>(STORAGE_KEYS.kintai, [])
  )
  ...
  useEffect(() => {
    saveToStorage(STORAGE_KEYS.kintai, records)
  }, [records])
  ...
  const handleDownloadCSV = () => {
    ...
    const monthLabel = currentTime.toLocaleDateString('ja-JP', { year: 'numeric', month: 'long' })
    downloadCSV([header, ...rows], `勤怠_${monthLabel}.csv`)
  }
